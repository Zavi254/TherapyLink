...
import { LuArrowLeft, LuArrowRightLeft, LuBuilding2, LuDollarSign, LuExternalLink, LuLock, LuPiggyBank, LuRefreshCw, LuShieldCheck, LuUserCheck } from "react-icons/lu";
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-8">
                ...
                {/* Main Connect Card */}
                <div className="bg-[#1e271c] border border-[#2c3928] rounded-2xl p-6 md:p-10 flex flex-col items-center text-center relative overflow-hidden">
                    ...
                    <div className="mb-6 relative">
                        <div className="size-24 bg-[#131811] rounded-full flex items-center justify-center border-4 border-[#2c3928] relative z-10 shadow-xl">
                            <LuBuilding2 color="text-gray-400" size={32} />
                        </div>
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">Connect with Stripe</h3>
                    ...
                    <div className="w-full max-w-sm bg-[#131811]/50 border border-[#2c3928] rounded-xl p-5 mb-8 text-left">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3 text-sm text-gray-300">
                                <FiCheckCircle size={24} className="text-green-500 mt-0.5" />
                    ...
                    <div className="mt-6 flex flex-col items-center gap-3">
                        ...
                        <div>
                            <FiAlertTriangle size={16} color="text-yellow-500 mt-0.5" />
                    ...
                    <div className="flex justify-start pt-4">
                        ...
                        >
                            <LuArrowLeft size={24} className="group-hover:-translate-x-1 transition-transform" />
                            Back
                        </button>
                    </div>
